\documentclass[12pt, a4paper]{article} %Dokumentinformationen/Präambelt
...
\item[Lieblingsmusik.]  
Cro
\item[bodyscore] %Eigenen Punkt erstellen
  Viel
\end{description}

\section{Bild in LaTex}

\includegraphics[height=100mm]{002-shrek-meme.jpg}
...
\end{table}
\ref{sec:sind mir egal}

\begin{table}
\centering
\begin{tabular}{l | l}
\multicolumn{2}{c}{\bf{hallo}}\\
\hline
   Leander  & klein \\
\hline
Darius & sehr klein\\
...
\begin{table}[]
    ...
    \begin{tabular}{c|c}
         ...
         & 
    \end{tabular}
    \caption{Das ist alles sehr interressant}
    \label{tab:my_label}
\end{table}
...
\section{Schriftart}
\section{sind mir egal}
\label{sec:sind mir egal}
